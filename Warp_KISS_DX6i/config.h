...
/*************************************************************************************************/
  ...
  /**************************    The type of multicopter    ****************************/
    ...
    // Use D7 output for Discovery Buzzer
    // Requires SPEKTRUM define below also
    //#define DISCO_BUZZER
    // Define the radio channel for Disco Buzzer activation
    // Should be one of: AUX1, AUX2, AUX3, AUX4
    // Otherwise the buzzer activates for failsafe
    //#define DISCO_CHANNEL AUX1
  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
      ...
      #define MOTOWII_REVB       // MotoLab 32u4_FC
 ...
 */
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_OFF_DELAY 50                     // Time for Landing before motors stop in 0.1sec. 1 step = 0.1sec - 5sec in example
